...
use Alians\StoneBundle\Entity\User;
...
class UserAdminController extends Controller
{
    ...
    public function createAction()
    {
        ...
        if ( isset( $id ) ) 
        {
            ...
            return $this->redirect( $this->generateUrl( 'admin_alians_stone_user_list' ) );
        }
        else
        {
    ...
    public function editAction($id=null)
    {
        ...
        if ( isset( $uniqid ) ) 
        {
            ...
            $repository = $this->getDoctrine()->getRepository("AliansStoneBundle:User");
            ...
            {
                return $this->redirect( $this->generateUrl( 'admin_alians_stone_user_edit', array( 'id' => $id ) ) );
            }
            ...
            {
                return $this->redirect( $this->generateUrl( 'admin_alians_stone_user_create') );
            }
        }
        else
        {
