...
class ArrisAdminController extends Controller
{
    ...
    {
       $repository = $this->getDoctrine()->getRepository(Setting::BUNDLE.":Arris");
    ...
    {
        $gallery = $this->getDoctrine()->getRepository(Setting::BUNDLE.":Gallery")->getAll();
        Container::setContainer('gallery',$gallery);
