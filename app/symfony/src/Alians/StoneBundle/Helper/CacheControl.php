...
{
    /**
     * check that content of the page are fresh
     * @param $doctrine Doctrine object
     * @param $request Request object
     * @param $response Response object
     * @param array $entities an array of strings representing the names of entities
     * @return array ( 'lastmodified'=> $lastModified, 'etag'=>$eTag  DateTime last modified entities and Etag
     **/
